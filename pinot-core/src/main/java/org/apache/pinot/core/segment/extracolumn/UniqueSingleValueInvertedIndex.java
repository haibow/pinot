...
public class UniqueSingleValueInvertedIndex extends BaseSingleColumnSingleValueReader<SortedIndexSingleValueReaderImpl.Context> implements SortedIndexSingleValueReader<SortedIndexSingleValueReaderImpl.Context> {
  private int _length;

  public UniqueSingleValueInvertedIndex(int length) {
    _length = length;
  }
