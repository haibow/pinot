...
public class UniqueMultiValueInvertedIndex extends BaseSingleColumnMultiValueReader<FixedBitMultiValueReader.Context> implements SortedIndexMultiValueReader<FixedBitMultiValueReader.Context> {
  private int _length;

  public UniqueMultiValueInvertedIndex(int length) {
    _length = length;
  }
